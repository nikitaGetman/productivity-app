...
#CLI
read -e -p "Enter path to your component folder (relative to 'src/components/'): " path
...
ComponentTemplate=$"import React$fcImport from 'react';\n\nimport styles from './$componentName.module.css';\n\nconst
...
echo >> $componentName.module.css
echo -e ${inFolder}$componentName.module.css
